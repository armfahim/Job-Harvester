...
/**
 * Genpact job site parser. <br>
 * URL: https://careers.genpact.com/search-results?
...
@Slf4j
@Service
public class Genpack extends AbstractScraper implements Scrapper {
	private static final String SITE = ShortName.GENPACT;
	...
	private Job getJobDetail(Job job) throws IOException {
		...
		WebElement el = wait.until(ExpectedConditions.presenceOfElementLocated(By.id("requisitionDescriptionInterface.ID1540.row1")));
