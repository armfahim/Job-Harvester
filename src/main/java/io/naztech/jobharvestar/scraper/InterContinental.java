...
/**
 * Inter Continental Bank Jobs site parser<br>
 * URL: https://theice.referrals.selectminds.com/jobs/search/10446
 * 
 * @author mahmud.rana
...
@Slf4j
@Service
public class InterContinental extends AbstractScraper implements Scrapper {
	private static final String SITE = ShortName.INTERCONTINENTAL_EXCHANGE;
	...
	public void scrapJobs() throws Exception{
		startSiteScrapping(getSiteMetaData(ShortName.INTERCONTINENTAL_EXCHANGE));
	}
	...
	private Job getJobDetail(Job job) throws IOException {
		...
		descDiv = doc.getElementById("24");
		job.setType(descDiv.text().split(":")[1].trim());
