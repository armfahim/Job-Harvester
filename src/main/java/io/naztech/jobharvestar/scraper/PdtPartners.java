...
@Service
public class PdtPartners extends AbstractScraper implements Scrapper {
	...
	private List<String> getSummaryPage(HtmlPage page){
	...
	private Job getJobDetails(String url , HtmlPage page) throws FailingHttpStatusCodeException, MalformedURLException, IOException {
		Job job = new Job();
		job.setUrl(url);
