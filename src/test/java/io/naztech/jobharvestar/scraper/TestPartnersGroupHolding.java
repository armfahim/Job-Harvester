...
public class TestPartnersGroupHolding {
	private static WebClient client;
	private static final String SITE_URL = "https://jobs.partnersgroup.com/search";
	...
	public void TestFirstJobUrl() {
		try {
			...
			System.out.println("https://jobs.partnersgroup.com"+jobUrl.get(0).getElementsByTagName("a").get(0).getAttribute("href"));
		} catch (FailingHttpStatusCodeException | IOException e) {
			System.out.println("Connection Failed");
		}
	}
