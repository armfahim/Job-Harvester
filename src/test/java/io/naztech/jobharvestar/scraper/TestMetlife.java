...
public class TestMetlife {
	...
	private static final String SITE_URL = "https://jobs.metlife.com/search";
	...
	public void TestFirstJobUrl() {
		try {
			...
			System.out.println("https://jobs.metlife.com"+jobUrl.get(0).getElementsByTagName("a").get(0).getAttribute("href"));
		} catch (FailingHttpStatusCodeException | IOException e) {
			System.out.println("Connection Failed");
		}
	}
